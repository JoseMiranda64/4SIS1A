...
public class cadena {
    ...
    public void cadenas(){
        ...
        System.out.println("El temaño de la cadena es" + s1.length());
       ...
       //vamos  obtener subcadenas de la palabra
       System.out.println("Parte de una subcadena de s1: " + s1.indexOf("tito"));

       //vamos a sustraer palabras
       System.out.println("Primera parte:" + s1. substring(beginIndex:7,endIndex:20));
    }
}