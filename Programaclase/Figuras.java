...
public class Figuras{
    ...
    public void menu(){
        ...
        do{
            ...
            System.out.println("¿Quieres repetir el programa?, escribe Y para repetir ");
            letra = entrada.next().charAt(0);

        }while(letra == 's' || letra == 'Y');
    }
    ...
    public void calcularCuadrado(){
        try{
            ...
            System.out.println("Escribe solamente valores numericos");
    ...
    public void calcularTriangulo(){
        ...
        System.out.println("Escribe 1 para el area y 2 para el perimetro : ");
        opcion = entrada.nextInt();
    ...
    public void calcularRectangulo(){
        ...
        switch(op){
            ...
            System.out.println("Escribe el lado a : ");
            lado = entrada.nextDouble();
            System.out.println("Escribe lado b : ");
            lado2 = entrada.nextDouble(); 
            System.out.println("Escribe el lado c : ");
            lado3 = entrada.nextDouble(); 
            System.out.println("Escribe el lado d : ");
