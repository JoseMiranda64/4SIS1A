...
public class Menu{
    public static void main(String args[]){
        ...
        do{
            System.out.println("\n\n\t\t MENU PRINCIPAL ");
            System.out.println("\n\nLee la opciones y elije la que necesites :");
            ...
            switch(op6){
                ...
                System.out.println("\n\nEscribe los grados en Fahrenheit : "); 
                ...
                case 3:
                System.out.println("\n\n\t\t FAHRENHEIT A RANKIN"); 
                System.out.println("\n\nEscribe los grados en Fahrenheint : "); 
                f = entrada.nextDouble(); 
                r = (f + 459.67);
            ...
            break;
                ...
                switch(op9){
                    ...
                    switch(op11){
                        ...
                        System.out.println("Escribe el lado b : "); 
                        lado_b = entrada.nextInt(); 
                        System.out.println("Escribe el lado c"); 
            ...
            switch(op12){
                case 1 :
                JOptionPane.showMessageDialog(null , "Hola"+ nombre);
                num1 = Integer.parseInt(JOptionPane.showInputDialog( "Escribe un numero para sumar : ")); 
                num2 = Integer.parseInt(JOptionPane.showInputDialog("Escribe el segundo numero a sumar ")); 
                suma = (num1 + num2); 
                JOptionPane.showMessageDialog(null,"El resultado de la suma es : "+suma );
                break; 
                case 2:
                JOptionPane.showMessageDialog(null,"Hola "+ nombre); 
                num1 = Integer.parseInt(JOptionPane.showInputDialog("Escribe un numero :"));
                num2 = Integer.parseInt(JOptionPane.showInputDialog("Escribe un numero : ")); 
                resta = num1 - num2; 
                ...
                do {
                    ...
                    System.out.println("\t\t**                 **"); 
                    System.out.println("\t\t*********************"); 
                    System.out.println("\n\nQuieres reimprimir el rectangulo?"); 
                    System.out.println(" 1 Si "); 
                    System.out.println(" 2 No "); 
                ...
                System.out.println("\n\nEscribe un numero positivo al que desea obtener el factorial");
                ...
                case 8:
                System.out.println("\n\n\t\t PATRON "); 
                System.out.println("\n\n Quieres desplegar el patron sorpresa?");
                System.out.println("1 Si \n2 No "); 
                op13 = entrada.nextInt(); 
                switch(op13){
                    case 1 :
                ...
                case 9:
                System.out.println("\n\n\t\t CUADRADO ");
                System.out.println("\n\nEscribe las dimensiones de la figura : "); 
                ...
                System.out.println("\n\nIngrese seis numeros distintos");
