...
public class Ejercicio {
    ...
    public void Ejercicio1() {
        ...
        System.out.println("Elige la operacion que desees realizar");
        ...
        switch (operacion) {
            case 'a':
                do {
                    System.out.println("Para parar la suma o resta ingrese el numero 0");
                    System.out.println("Escribe los numeros que desee sumar o restar");
            ...
            case 'b':
            do {
                System.out.println("Para parar la multiplicaion ingrese el numero 0");
                System.out.println("Escribe los numeros que desee sumar o restar");
                num1 = entrada.nextDouble();
                multi *= num1;
                // multi = multi * num1;
            ...
            System.out.println("El resultado es: " + multi);
                ...
                break;
            case 'c':do{
                System.out.println("Para parar division ingrese el numero 0");
                System.out.println("Escribe el numerador ");
                num1 = entrada.nextDouble();
                System.out.println("Escribe el denomidador");
    ...
    public void Ejercicio2() {
        ...
        System.out.println(" Escoje la cantidad que desee convertir a las siguientes unidades");
        ...
        switch(op){
            ...
            case 'a':
            System.out.println("Escribe los metros a transformar ");
            ...
            break;
            case 'b':
            System.out.println("Escribe los gramos a transformar ");
            ...
            case 'c':
            System.out.println("Escribe la m/s a transformar ");
            ...
            break;
            case 'd':
            System.out.println("Escribe los pesos a convertir");
    ...
    char letra;
        do{
            ...
            System.out.println("habiendo tantos numeros escogiste uno negativo y mayor a mill, seras pelotudo");
              ...
              System.out.println("Quieres repetir el programa, escribe s para si");
